// shared.jsx — primitives: icons, top nav, avatar, footer
...
const Avatar = ({ name, size = 36, variant = 1, square = false }) => {
...
// Top nav
function TopNav({ view, onNav, signedIn, onOpenInvite, onSignIn, onSignOut, theme, onToggleTheme }) {
...
Object.assign(window, { Icon, Avatar, InvitationBadge, Brand, TopNav, Footer });
