// dashboard.jsx — recruiter dashboard (post sign-in)

function Dashboard({ onNav, onOpenMandate, onOpenInvite }) {
  return (
    <div className="page">
      ...
      <div className="dash-section">
        ...
        <div className="candidates-list">
          {window.CANDIDATES.slice(0, 3).map(c => (
...
const CandidateRow = ({ c, onClick, anonymized = false }) => (
    ...
    <div style={{ minWidth: 0 }}>
      ...
      <div className="candidate-tags">
        ...
        {c.stages.slice(0, 2).map(s => {
          const stage = window.STAGES.find(x => x.id === s);
...
Object.assign(window, { Dashboard, CandidateRow });
